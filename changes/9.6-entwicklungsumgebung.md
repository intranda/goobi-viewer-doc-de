...
Benötigt wird die Version **Eclipse IDE for Java EE Developers**, die unter folgendem Link zu bekommen ist: [eclipse Download](https://www.eclipse.org/downloads/)

Als Plugins empfehlen sich:

* [Emmet](https://docs.emmet.io/) \(eclipse Marketplace\)
...
<Resource 
	...
	url="jdbc:mysql://localhost:3306/standard?characterEncoding=UTF-8&amp;autoReconnect=true&amp;autoReconnectForPools=true"
	username="root" 
	password="root" />
```
{% endcode-tabs-item %}
