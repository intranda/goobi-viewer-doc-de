...
Der Goobi viewer kann Sammlungen mit einer Hierarchie anzeigen. Die Funktionalität ist in [Kapitel 2.18.1](../2/2.18/2.18.1.md) beschrieben.
...
Die Sammlungen können wie gewohnt über die [messages Dateien](../2/2.2.md) übersetzt werden.
