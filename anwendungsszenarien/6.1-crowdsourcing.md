...
Die Konfigurationsdatei `config_crowdsourcing.xml` befindet sich in dem [lokalen Konfigurationsordner](../konfiguration-core/2.1-lokale-einstellungen.md) neben den anderen Konfigurationsdateien.Der Pfad dorthin wird in der `config_viewer.xml` definiert und muss den vollen Pfad zur Datei enthalten:
