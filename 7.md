...
Um die Zusammensetzung der drei Stellen zu verstehen muss die Arbeitsweise kurz erklärt werden.   
...
Die zweite Stelle bezeichnet die sogenannte `Minor Version` und wird immer hochgezählt, wenn ein fertiges Arbeitspaket auf dem Develop Branch in den Master einfließt. 

Die dritte Stelle bezeichnet den `Patchlevel`. Sollte doch einmal im stabilen Master Branch ein Fehler auftreten und ein Bugfix release notwendig sein, dann wird dieser direkt in den Master eingespielt und das Patchlevel hochgezählt.
