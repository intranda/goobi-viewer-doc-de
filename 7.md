...
Die zweite Stelle bezeichnet die sogenannte `Minor Version` und wird immer hochgezählt, wenn ein fertiges Arbeitspaket auf dem Develop Branch in den Master einfließt. In dem oben genannten Beispiel ist die Minor Version die 2.
