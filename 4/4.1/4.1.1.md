...
```markup
<solr>
    <solrUrl>http://localhost:983/solr</solrUrl>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Hier besteht die M&#xF6;glichkeit Zugriffsbeschr&#xE4;nkungen zu konfigurieren,
        ...
        werden kann. Analog zur Konfiguration der <a href="../../6/6.2.md">Moving Wall</a> werden
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style="text-align:left">
        <p>&lt;b&gt;&lt;/b&gt;</p>
        <p>Pfad der die Goobi viewer Konfigurationsdateien enth&#xE4;lt, zum Beispiel
          die lokale <code>config_oai.xml</code> Datei.</p>
      </td>
    </tr>
    <tr>
