...
Bei den Metadaten in der Seitenleiste muss zwischen zwei Stellen für die Anzeige unterschieden werden:

1. Die Anzeige im Vollbildmodus
2. Die Anzeige innerhalb der Werksansicht 

Bei der Anzeige im Vollbildmodus werden auch die Metadaten der übergeordneten Strukturelemente angezeigt. Hier greift die Konfiguration wie in [Kapitel 2.19.1](2.19.1.md) beschrieben.

Bei der Anzeige innerhalb der Werksansicht werden immer nur die Metadaten zum aktuellen Strukturelement angezeigt. Die Konfiguration dafür ist erfolgt analog zu denen der Haupt-Metadaten:
