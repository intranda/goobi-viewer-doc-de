  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Wenn dieses Attribut auf <code>true </code>steht und die Metadatenansicht
        die einzige verf&#xFC;gbare Ansicht f&#xFC;r dieses Werk ist, wird der
        Link mit dem Label des Werks belabelt, anstatt &quot;Bibliographische Daten&quot;
        o.&#xE4;. Standardwert ist <code>false</code>.</td>
    </tr>
    <tr>
