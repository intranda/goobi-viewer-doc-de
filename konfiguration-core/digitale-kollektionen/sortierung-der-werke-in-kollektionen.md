...
Im obigen Beispiel wird die Kollektion `collection1` standardmäßig nach dem Werkstitel sortiert. Die Erstsortierung nach dem Öffnen kann wiederum durch [manuelle Auswahl der Sortierung](../suche/sortierung.md) im Sortiermenü geändert werden.
