...
In der Konfigurationsdatei wurde der Block für die Kommentare umbenannt und muss von der Benennung und der Syntax angepasst werden:
...
```markup
<metadata label="MD_TITLE" value="" hideIfOnlyMetadataField="true">
    <param type="field" key="MD_TITLE"/>
</metadata>
<metadata label="DOCSTRCT_TOP" value="">
    <param type="translatedfield" key="DOCSTRCT_TOP" topstructOnly="true"/>
</metadata>
<metadata label="DOCSTRCT_SUB" value="" hideIfOnlyMetadataField="true">
