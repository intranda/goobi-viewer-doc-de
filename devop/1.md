...
Damit die vom Goobi viewer generierten [IIIF Presentation Manifeste](../conf/1/33/3.md) von extern funktionieren, muss CORS erlaubt werde. Dafür das Headers Modul im Apache aktivieren sofern noch nicht geschehen:
