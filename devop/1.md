...
Die Aufrufe für Sitemap-Update und Search-Update-Notification müssen auf die neue Api aktualisiert werden. Siehe [https://docs.goobi.io/goobi-viewer-de/devop/3\#cronjob\_installieren](https://docs.goobi.io/goobi-viewer-de/devop/3#cronjob_installieren).
...
Um die Sortierung von Bänden flexibler zu gestalten muss das Solr Schema aktualisiert werden. Das kann mit den folgenden Zeilen erfolgen:
