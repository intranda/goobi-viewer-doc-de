...
Die Facettierung der Suche ist umbenannt worden:
...
* [ ] boilerplate/css/less/widgets/**widgetCustomFacets.less**
* [ ] boilerplate/css/less/**constructor.less**

Änderungen CSS Klassen:
...
/*** NEU ***/
.widget-search-facets
.widget-custom-facets
```
...
Im Footer sollte der Link zum Kontaktformular angepasst werden sowie die CSS Eigenschaft `cursor: pointer;` auf den Link gesetzt werden.
...
<!-- NEU -->
<a data-toggle="modal" data-target="#feedbackModal">#{msg.contact}</a>
```
