...
Die Methode zur Kennzeichnung der aktuellen Seite wurde angepasst. Es werden nun nicht mehr veränderliche Texteinträge zur Identifikation der CMS Seiten herangezogen, sondern festbleibende IDs. Themes sollten daher nach folgendem Eintrag durchsucht werden:
...
```markup
<!-- BEISPIEL ALT -->
<ui:fragment rendered="#{navigationHelper.currentPage == 'start'}">
