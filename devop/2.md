...
### Ergänzung in Template Chronology-Slider
...
​Optimalerweise ist ein Kommentar zu hinterlassen, dass die Dateien aufgrund von Überlappungen mit dem Styling der eigenständigen Seiten \(Swagger API, Mirador\) entfernt wurden.
