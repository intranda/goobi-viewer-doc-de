...
In der Konfigurationsdatei wurden die XML-Elemente für die Suchtreffer- und Sidebarmetadatenlisten umbenannt. Mit den folgenden Aufrufen kann das in der lokalen config\_viewer.xml nachgezogen werden:
...
Außerdem wurden drei Einträge verschoben. Hier ist zu prüfen, ob die Einträge in der lokalen `config_viewer.xml` existieren und wenn ja, müssen diese an die neue Stelle verschoben werden:
