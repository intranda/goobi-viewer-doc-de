...
Der Indexer schreibt ein neues Feld MONTHDAY wofür ein Update des Schemas erforderlich ist:
...
In der Apache-Config finden sich ggf. noch veraltete Optionen, die das Funktionieren von Websockets unter Umständen verhinden. Diese biden Zeilen löschen:
```apacheConf
