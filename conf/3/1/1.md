...
| **fulltextUrl**            | <p>URL zur Goobi viewer Core REST API zum Abrufen von Volltext Einzelseiten. Erlaubte Parameter die vom Indexer automatisch ausgefüllt werden sind:</p><ul><li><code>{pi}</code></li><li><code>{fileName}</code></li><li><code>{page}</code></li></ul> |
