...
| **location**  | Gibt an, wo die Metadaten aus dem view angezeigt werden sollen. Mögliche werte sind `sidebar` und `objectview`. Der Wert `sidebar` bildet das Standardverhalten ab und rendert einen Link "Bibliographische Daten" im Widget "Ansicht". Der Wert `objectview` zeigt die Metdaten unterhalb der Bildanzeige an.  |
...
| **inputPattern**       | Hier kann das Pattern für das Ausgangsformat des Datums definiert werden, damit der Wert korrekt als Datum geparst werden kann, zum Beispiel `yyyyMMdd`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
