  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Dieser Ordner dient als Ablage f&#xFC;r etwaige Mediendateien (Bilder,
        ...
        Ordner in den Goobi viewer geladen werden. Dieser Ordner wird relativ zu
        dataRepositoriesHome (bei <code>dataRepositories/enabled = true</code>)
        beziehungsweise zu viewerHome (bei <code>dataRepositories/enabled = false</code>)
        gesucht beziehungsweise angelegt. Aus diesem Grund darf der Wert nur den
        Namen und keinen absoluten Pfad enthalten.</td>
    </tr>
    <tr>
      <td style="text-align:left"><b>pyramidTiffFolder</b>
      </td>
      <td style="text-align:left">Dieser Ordner enth&#xE4;lt zus&#xE4;tzlich zu regul&#xE4;ren Bildern,
        die im mediaFolder liegen, gegebenenfalls gekachelte Pyramiden-TIFF Dateien.
        Dieser Ordner wird relativ zu dataRepositoriesHome (bei <code>dataRepositories/enabled = true</code>)
        beziehungsweise zu viewerHome (bei <code>dataRepositories/enabled = false</code>)
        gesucht beziehungsweise angelegt. Aus diesem Grund darf der Wert nur den
        Namen und keinen absoluten Pfad enthalten.</td>
    </tr>
    ...
    <tr>
      ...
      <td style="text-align:left">Hier werden die (plaintext) Volltext Dateien nach dem Indexieren abgelegt.
        ...
        <br />Dieser Ordner wird relativ zu dataRepositoriesHome (bei <code>dataRepositories/enabled = true</code>)
    ...
    <tr>
      ...
      <td style="text-align:left">Hier werden vorgerenderte PDF Dateien f&#xFC;r die einzelnen Seiten des
        ...
        wird relativ zu dataRepositoriesHome (bei <code>dataRepositories/enabled = true</code>)
        beziehungsweise zu viewerHome (bei <code>dataRepositories/enabled = false</code>)
        gesucht beziehungsweise angelegt. Aus diesem Grund darf der Wert nur den
        Namen und keinen absoluten Pfad enthalten.</td>
    </tr>
    ...
    <tr>
      <td style="text-align:left"><b>mixFolder</b>
      </td>
      <td style="text-align:left">Hier werden die MIX Dateien (technische Informationen &#xFC;ber die Bilder
        des Objekts) nach dem Indexieren abgelegt. Diese werden jeweils in einem
        Unterordner abgelegt, der den Identifier des jeweiligen Objekts als Namen
        tr&#xE4;gt. Sie sind zwar nicht f&#xFC;r den Betrieb des Goobi viewers
        erforderlich (relevante MIX Daten werden indexiert), allerdings k&#xF6;nnen
        sie f&#xFC;r eine evtl. Reindexierung eines Objekts wiederverwendet werden
        (f&#xFC;r den Fall, dass kein MIX Ordner im Hotfolder gefunden wird, sucht
        der Goobi viewer Indexer nach einem bereits vorhandenen MIX Ordner aus
        fr&#xFC;herer Indexierung). Dieser Ordner wird relativ zu dataRepositoriesHome
        (bei <code>dataRepositories/enabled = true</code>) beziehungsweise zu viewerHome
        (bei <code>dataRepositories/enabled = false</code>) gesucht beziehungsweise
        angelegt. Aus diesem Grund darf der Wert nur den Namen und keinen absoluten
        Pfad enthalten.</td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">Hier werden die METS Dateien nach dem Indexieren abgelegt. Sie sind nicht
        ...
        wird. Dieser Ordner wird relativ zu dataRepositoriesHome (bei <code>dataRepositories/enabled = true</code>)
        beziehungsweise zu viewerHome (bei <code>dataRepositories/enabled = false</code>)
        gesucht beziehungsweise angelegt. Aus diesem Grund darf der Wert nur den
        Namen und keinen absoluten Pfad enthalten.</td>
    </tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Hier werden die originalen LIDO Dateien, so wie sie im Hotfolder vorgefunden
          werden, abgelegt. Diese k&#xF6;nnen u.U. Tausende von Objekten enthalten,
          die zun&#xE4;chst in einzelne LIDO Datens&#xE4;tze aufgespalten werden
          (siehe 3.1.13). Die originalen Dateien sind f&#xFC;r den Betrieb nicht
          notwendig und dienen nur der Archivierung.</p>
        <p></p>
        <p><em>F&#xFC;r den Goobi viewer besitzt dieser Ordner keine Relevanz, muss aber dennoch existieren.</em>
        </p>
      </td>
