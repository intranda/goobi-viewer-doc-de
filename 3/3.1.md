  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Bei der Indexierung von mehrb&#xE4;ndigen Werken kann es vorkommen, dass
        B&#xE4;nde unterschiedlichen Kollektionen angeh&#xF6;ren. Wenn dieses Element
        auf <code>true</code> steht, werden Kollektionsnamen aus allen im Index enthaltenen
        B&#xE4;nden auch in das Gesamtwerk kopiert (Kollektionen, denen nur das
        Gesamtwerk angeh&#xF6;rt, bleiben ebenfalls erhalten). Zu beachten ist
        hier, dass evtl. Schreibfehler bei Kollektionsnamen nicht mehr automatisiert
        aus dem Gesamtwerk entfernt werden k&#xF6;nnen, wenn diese Option aktiviert
        ist. Standardwert ist <code>false</code>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">Sofern bei der Indexierung Fehler auftreten kann der Goobi viewer Indexer
        ...
        Konfiguration erfolgt analog zu der in <a href="../2/2.5/2.5.2.md">Kapitel 2.5.2</a> beschriebenen
        Weise.</td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">Damit beim Verschieben von Datens&#xE4;tzen zwischen DataRepositories
        ...
        Sie dazu auch <a href="../2/2.33/2.33.3.md">Kapitel 2.33.3</a>.</td>
    </tr>
  </tbody>
</table>
