...
#### 3.1.14 Parameter: fulltextForceUTF8
...
#### 3.1.15 Parameter: lido/imageXPath
...
Damit beim Verschieben von Datensätzen zwischen DataRepositories der Goobi viewer über die Änderung informiert werden kann, wird ein Token benötigt. Der Token wird in der config\_viewer.xml hinterlegt. Sie dazu auch [Kapitel 2.33.3](../2/2.33/2.33.3.md).
